...
import samsidere.PerylClient.mixin.accessors.RenderManagerAccessor;
import samsidere.PerylClient.utils.objects.Shader;
...
public class RenderUtils {
    ...
    public static void renderWaypointText(String str, double X, double Y, double Z, float partialTicks, boolean showDist) {
        ...
        Entity viewer = PerylClient.mc.getRenderViewEntity();
        RenderManagerAccessor rm = (RenderManagerAccessor) mc.getRenderManager();
        ...
        GlStateManager.rotate(-PerylClient.mc.getRenderManager().playerViewY, 0.0F, 1.0F, 0.0F);
        GlStateManager.rotate(PerylClient.mc.getRenderManager().playerViewX, 1.0F, 0.0F, 0.0F);
