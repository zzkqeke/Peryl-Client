...
public class VectorUtils {
    ...
    private static final HashMap<Integer, KeyBinding> keyBindMap = new HashMap<Integer, KeyBinding>() {
        {
            put(0, PerylClient.mc.gameSettings.keyBindForward);
            put(90, PerylClient.mc.gameSettings.keyBindLeft);
            put(180, PerylClient.mc.gameSettings.keyBindBack);
            put(-90, PerylClient.mc.gameSettings.keyBindRight);
        }
    };
